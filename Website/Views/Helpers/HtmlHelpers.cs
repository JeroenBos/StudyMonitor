...
namespace Website.Views.Helpers
{
	...
	{
		public static HtmlString CreateTask(string taskId, string taskName, bool taskIsOpen, bool anyOtherTaskIsOpen)
		{
			return CreateTask(taskId, taskName, hideButton: !taskIsOpen && anyOtherTaskIsOpen, buttonCaption: taskIsOpen ? "Stop" : "Start");
		}
		public static HtmlString CreateTask(string taskId, string taskName, bool hideButton, string buttonCaption)
		{
			var htmlResult =
